...
public class DecisionCodeletNet extends Codelet {
...
private QLStepReturn<Observation> ql;
...
public DecisionCodeletNet (OutsideCommunication outc, int tWindow, int sensDim, String mode, String motivation, int num_tables, int num_pioneer) {
   ...
   */
	...
	/*try {
       ...
       if(qList.isEmpty()){
            ...
            ql = (QLStepReturn<Observation>) qList.get(qList.size()-1);
